sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Contactos_detail", {
		/**
		...
		onInit: function () {
			...
			oRouter.getRoute("Contactos_detail").attachMatched(this._onRouteMatched, this);
		},
