sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Include_Lista", {
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf HyssoftWeb.HyssoftWeb.view.Include_Lista
		 */
		onInit: function () {},
		handleListItemPress: function (oEvent) {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			var selectedNOMBRE = oEvent.getSource().getBindingContext().getProperty("NOMBRE");
			oRouter.navTo("Include_detail", {
