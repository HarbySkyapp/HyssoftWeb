sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Parametros_Detail", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("parametro_detail").attachMatched(this._onRouteMatched, this);
		},
		_onRouteMatched: function (oEvent) {
			...
			oView = this.getView();
			oView.bindElement({
				path: "/ParametrosPenta('" + oArgs.NOMBRE + "')",
				events: {
		...
		onDelete0: function (oEvent) {
			...
			Model.remove("/ParametrosPenta('" + empnit + "')", true);
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
