sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Penta_Detail", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("penta_detail").attachMatched(this._onRouteMatched, this);
		},
		_onRouteMatched: function (oEvent) {
			...
			oView = this.getView();
			oView.bindElement({
				path: "/PentaEmpresa('" + oArgs.PROGRAMA_NOMBRE + "')",
				events: {
		...
		onDelete0: function (oEvent) {
			...
			var empnit = Empresas["PROGRAMA_NOMBRE"];
			Model.remove("/PentaEmpresa('" + empnit + "')", true);
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
