sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Programas_crear_aplic", {
		/**
		...
		onInit: function () {
			...
			oRouter.getRoute("Programas_crear_aplic").attachMatched(this._onRouteMatched, this);
		},
		
		crearprogramaApl: function () {
		...
		modificarcontacto: function (oEvent) {
			...
			var Model = this.getView().getModel();
			Model.update("/apphyssoft('" + CODIGO + "')", payLoad, {
				MERGE: true,
