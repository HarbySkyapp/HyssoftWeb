sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Empresas_Detail", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("empresas_detail").attachMatched(this._onRouteMatched, this);
		},
		...
		handleListItemPressContactos: function (oEvent) {
			...
			oRouter.navTo("Contactos_Crear_Dos", {
				NIT: selectedNIT
			});
		},
		...
		onDelete0: function (oEvent) {
			...
			var empnit = Empresas["NIT"];
			Model.remove("/Empresas('" + empnit + "')", true);
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
