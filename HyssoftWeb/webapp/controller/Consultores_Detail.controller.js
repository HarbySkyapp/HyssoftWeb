sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Consultores_Detail", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("consultores_detail").attachMatched(this._onRouteMatched, this);
		},
		...
		onDelete0: function (oEvent) {
			...
			var empnit = Empresas["CEDULA"];
			Model.remove("/Consultores(" + empnit + ")", true);
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
            oRouter.navTo("Consultores_Lista");
		},
