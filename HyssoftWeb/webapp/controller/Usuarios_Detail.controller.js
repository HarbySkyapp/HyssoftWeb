sap.ui.define(["sap/ui/core/mvc/Controller"], function (Controller, MessageToast) {
	"use strict";
	return Controller.extend("HyssoftWeb.HyssoftWeb.controller.Usuarios_Detail", {
		onInit: function () {
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			oRouter.getRoute("usuario_detail").attachMatched(this._onRouteMatched, this);
		},
		...
		onDelete0: function (oEvent) {
			...
			Model.remove("/Usuarios('" + empnit + "')", true);
			var oRouter = sap.ui.core.UIComponent.getRouterFor(this);
